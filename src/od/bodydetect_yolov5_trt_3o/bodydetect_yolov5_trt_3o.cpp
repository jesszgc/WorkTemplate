...
odService* bodydetectinit_yolov5_trt_3o(odinitconfig config)
{
    bodyDetectYolov5Trt * ch=new bodyDetectYolov5Trt(config.modelpath,config.gpu,config.threadnum,config.netsize,config.maxbatchsize);
    if(ch->initsuccess<0)
    {
        return nullptr;
    }
